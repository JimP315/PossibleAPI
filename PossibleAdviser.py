...
# Database of Fintech Finder candidates including their name, digital address, adviser rating and hourly cost per Ether.
# A single Ether is currently valued at $1,500
candidate_database = {
    "Jim": ["Jim", "0xaC8eB8B2ed5C4a0fC41a84Ee4950F417f67029F0", "5.0", .20, "Images/Jim.jpeg"],
    "Jon": ["Jon", "0x2422858F9C4480c2724A309D58Ffd7Ac8bF65396", "5.0", .33, "Images/Jon.jpeg"],
    "Blaine": ["Blaine", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.8", .19, "Images/Blaine.jpeg"],
    "Maria": ["Maria", "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45", "4.8", .16, "Images/Maria.jpeg"]
}

# A list of the FinTech Finder candidates first names
people = ["Jim", "Jon", "Blaine", "Maria"]
...
def get_people():
    ...
    for number in range(len(people)):
        ...
        st.write("FinAdviser Adviser Rating: ", db_list[number][2])
...
st.markdown("# Financial Advice Finder!")
st.markdown("## Hire A Financial Fintech Professional!")
st.text(" \n")
