...
all_advisers = [
    "Jim Penner - Adviser Ratings 4.95", 
    "Jon Morrow - Adviser Ratings 4.8",
    "Blaine Miller - Adviser Ratings 4.75",
    "Maria Anderson - Adviser Ratings 4.7",  
]
...
def main():
    ...
    investment_aud = st.sidebar.text_input("Initial Investment Amount ($AUD)", value=0)
    ...
    if current_adviser == "Jim Penner - Adviser Ratings 4.95":
        st.markdown(
    ...
    elif current_adviser == "Jon Morrow - Adviser Ratings 4.8":
        st.markdown(
    ...
    elif current_adviser == "Blaine Miller - Adviser Ratings 4.75":
        st.markdown(
